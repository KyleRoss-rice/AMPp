...
void cDrawSceneSimChar::IncreaseGravity()
{
    printf("Increased gravity\n");
    auto world = mScene->GetWorld();
    world->SetGravity(world->GetGravity() + Eigen::Vector4d(0, -1, 0, 0));
}

void cDrawSceneSimChar::DecreaseGravity()
{
    printf("Decreased gravity\n");
    auto world = mScene->GetWorld();
    world->SetGravity(world->GetGravity() + Eigen::Vector4d(0, 1, 0, 0));
}
